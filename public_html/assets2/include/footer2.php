  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Cliquez sur "Déconnexion" si vous etes prets à fermer la session.</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Annuler</button>
          <a class="btn btn-primary" href="<?php echo site_url("Login_Controller/logout");?>">Déconnexion</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="<?php echo base_url("assets2/js/sort.js");?>"></script>
  ...
  <script src="<?php echo base_url("assets2/js/custom-file-input.js");?>"></script>
