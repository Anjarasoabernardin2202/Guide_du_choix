                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Modifier membre?</h1>
                    </div>
                    <?php foreach($single as $equipe) { ?>
                    <form class="user" method="post" action="<?php echo site_url("Equipe_Controller/update");?>/<?php echo $equipe->ID_MEMBRE;?>" enctype="multipart/form-data">

                    <div class="form-inline" style="margin-bottom:1rem">
                    
                    <div class="col-6">
                         <img style="width:200px;height:100px" src="<?php echo base_url();?>/assets/image/<?php echo $equipe->PROFIL_MEMBRE;?>">
                    </div>
                    <div class="col-6">
                    <div class="form-group js">
                      <input type="hidden" name="img" value="<?php echo $equipe->PROFIL_MEMBRE;?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                              ...
                              <option value="<?php echo $equipe->TYPE_MEMBRE;?>"><?php echo $equipe->TYPE_MEMBRE;?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="text" name="nommembre" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" value="<?php echo $equipe->NOM_MEMBRE;?>">
                      </div>
                      <div class="form-group">
                        <input type="text" name="poste" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" value="<?php echo $equipe->POSTE;?>">
                      </div>
                    ...
                    <?php } ?>
                      ...
                      <a href="<?php echo site_url("Equipe_Controller/equipe_bo");?>" class="btn btn-default btn-user btn-block">
                        Annuler
                    </a>
