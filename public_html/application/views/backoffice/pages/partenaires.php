  ...
  <?php include("assets2/include/menu.php");?>
    ...
    <?php $this->load->view("backoffice/include/header.php");?>
        ...
        <div class="container-fluid">
          ...
          <?php } ?>
          <a data-toggle="collapse" data-target="#reponse" id="question"><button class="btn btn-primary">Cliquez ici pour insérer un partenaire <i class="fa fa-chevron-down"></i></button></a>
                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Nouveau partenaire?</h1>
                    </div>
          ...
          <?php if($erreur != null && isset($erreur[5])) { 
                      ...
                      <?php } ?>
                    <form class="user" method="post" action="<?php echo site_url("Parrain_Controller/createPartenaire");?>" enctype="multipart/form-data">
                    <div class="form-inline" style="margin-bottom:1rem">
                    
                    <div class="col-4">
                        <p class="text-gray-900 ">Image Partenaire*:</p>
                    </div>
                    <div class="col-8">
                    ...
                    <div class="col-8">
                      <div class="form-group js">
                            <input type="text" name="nompartenaire" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nom">
          ...
          <div class="card mb-4 py-3 border-left-primary">
              <div class="card-body">
                  <div class="table-responsive">
                      <table id="dtBasicExample" class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                          <tr>
                            <th>#</th>
                            <th>Image</th>
                        ...
                        <tbody>
                        <?php foreach($liste as $partenaire) { ?>
                          <tr>
                            <td><?php echo $partenaire->ID_PARTENAIRE;?></td>
                            <td><img style="height:80px;width:auto;" src="<?php echo base_url()?>/assets/image/<?php echo $partenaire->IMAGE_PARTENAIRE;?>"></td>
                            <td><?php echo $partenaire->NOM_PAYS;?></td>
                            <td><?php echo $partenaire->NOM_PARTENAIRE;?></td>
                            <td><?php echo $partenaire->DESCRIPTION_PARTENAIRE;?></td>
                            <td><?php echo $partenaire->INTRODUCTION_PARTENAIRE;?></td>
                            <td>
                            <a href="<?php echo site_url('Parrain_Controller/readPartenaire');?>/<?php echo $partenaire->ID_PARTENAIRE;?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                    
                                    <form action="<?php echo site_url("Parrain_Controller/deletePartenaire");?>/<?php echo $partenaire->ID_PARTENAIRE;?>" method="post" onsubmit="if(confirm('Voulez vous vraiment supprimer ce partenaire?')){return true;}else{return false;}">
