    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php $this->load->view("backoffice/include/header.php");?>
        ...
        <div class="container-fluid">
          ...
          <?php } ?>
          <a data-toggle="collapse" data-target="#reponse" id="question"><button class="btn btn-primary">Cliquez ici pour insérer un chapitre <i class="fa fa-chevron-down"></i></button></a>
                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    <div class="text-center">
                      <h5 class="text-gray-900 mb-4">Nouveau chapitre?</h5>
          ...
          <?php } ?>
                    <form class="user" method="post" action="<?php echo site_url('Chapitre_Controller/createChapitre');?>">
         
                      <div class="form-group">
                      <p class="text-gray-900 ">Choisissez un guide * <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction1"><i class="fa fa-question-circle"></i></a>:</p>

                      <div class="col-md-10">
                              <select name="nomguide" class="form-control">
                              <option value="">Pas selectionné</option>
                              <?php foreach($listeguide as $guide) { ?>
                                <option value="<?php echo $guide->ID_GUIDE;?>"><?php echo $guide->NOM_GUIDE;?></option>
                              <?php } ?>
                              </select>
                          </div>
                      ...
                      <div class="form-group">
                      <p class="text-gray-900 ">Choisissez le type * <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction1"><i class="fa fa-question-circle"></i></a>:</p>
                      ...
                      <div class="form-group">
                      <p class="text-gray-900 ">Titre  * <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction2"><i class="fa fa-question-circle"></i></a>:</p>

                        <input type="text" name="nomchapitre" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Titre">
                      ...
                      <div class="form-group">
                      <p class="text-gray-900 ">Numéro * <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction3"><i class="fa fa-question-circle"></i></a>:</p>
                      ...
                      <div class="form-group">
                      <p class="text-gray-900 ">Introduction  <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction4"><i class="fa fa-question-circle"></i></a>:</p>
                      ...
                      <div class="form-group">
                      <p class="text-gray-900 ">Smartphone <a style="color: #4e73df" href="javasript:void()" data-toggle="modal" data-target="#instruction5"><i class="fa fa-question-circle"></i></a>:</p>
          ...
          <b><i class="fa fa-warning"></i> Attention: Si vous comptez supprimer un chapitre, il faut savoir que s'il a des données s'y rattachant il ne pourra pas etre supprimer et vous devez les supprimer en premier lieu. </b>
                  ...
                  <div class="table-responsive">
                      <table id="dtBasicExample" class="table table-bordered dataTable"  width="100%" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $chapitre->NOM_GUIDE;?></td>
                            <td><?php echo $chapitre->NUMERO_CHAPITRE;?></td>
                            <td><?php echo $chapitre->NOM_CHAPITRE;?></td>
                            <td><?php echo $chapitre->TYPE_CHAPITRE;?></td>
                            <td><?php echo $chapitre->INTRODUCTION_CHAPITRE;?></td>
                            <td><?php echo $chapitre->INTRODUCTION_CHAPITRE_SMARTPHONE;?></td>
                            <td>
                                  <a href="<?php echo site_url('Chapitre_Controller/readChapitre');?>/<?php echo $chapitre->ID_CHAPITRE;?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                 
                                    <form action="<?php echo site_url("Chapitre_Controller/deleteChapitre");?>/<?php echo $chapitre->ID_CHAPITRE;?>" method="post" onsubmit="if(confirm('Voulez vous vraiment supprimer ce chapitre?')){return true;}else{return false;}">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Un guide a plusieurs chapitres qui vont permettre aux visiteurs de bien comprendre les informations. C'est comme une structurisation des données.</p>  
        ...
        <div id="instruction2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createmodal" aria-hidden="true" >
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Le titre du chapitre sera le point déterminant qui va intéresser les visiteurs.</p>  
        ...
        <div id="instruction3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createmodal" aria-hidden="true" >
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Pour une bonne structuration des chapitres,une numérotisation est primordiale. Attention: les chapitres dans un meme guide ne peuvent avoir les memes numéros.</p>  
        ...
        <div id="instruction4" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createmodal" aria-hidden="true" >
              <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>C'est une phrase introductive du chapitre pour savoir le contenant du chapitre.</p>  
